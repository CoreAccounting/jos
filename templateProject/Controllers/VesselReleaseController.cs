...
{
    public class VesselReleaseController : Controller
    {
        #region Uow
        ...
        [CustomAuthorize(Users = "VesselRelease", Roles = "read")]
        public ActionResult Index()
        {
            return View();
        }

        [CustomAuthorize(Users = "VesselRelease", Roles = "create")]
        ...
        [CustomAuthorize(Users = "user", Roles = "create")]
        [HttpPost]
