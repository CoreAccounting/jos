        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/Themes/Core").Include(
                ...
                "~/Content/js/plugin/bootstrap-datepicker/css/bootstrap-datepicker.min.css",
                 "~/Content/wizard/css/smart_wizard_theme_circles.css",
                "~/Content/wizard/css/smart_wizard_theme_arrows.css",
                 "~/Content/wizard/css/smart_wizard_theme_dots.css"
                ));
            ...
            bundles.Add(new ScriptBundle("~/Script/Core").Include(
                        ...
                        "~/Content/js/jquery-simple-tree-table.js",
                          "~/Content/js/jquery-printme.js",
